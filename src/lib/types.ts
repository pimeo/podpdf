...
export type Type = 'text' | 'rect' | 'line' | 'circle' | 'image' | 'link' | 'table'
export interface Size { width: number; height: number }
export interface TextOpts { size?: number; color?: Color; align?: Align; weight?: Weight; maxWidth?: number; font?: string, id?: string, notInBounding?: boolean }
export interface RectOpts { fill?: Color; stroke?: Color; lineWidth?: number; radius?: number, id?: string, notInBounding?: boolean }
export interface LineOpts { color?: Color; width?: number; dash?: number[], id?: string, notInBounding?: boolean }
export interface CircleOpts { fill?: Color; stroke?: Color; lineWidth?: number, id?: string, notInBounding?: boolean }
...
export interface BoundingElement { type: Type, width: number; height: number; offsetX?: number, offsetY?: number, id?: string }